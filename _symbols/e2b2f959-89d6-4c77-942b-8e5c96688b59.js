// Site Footer - Updated August 10, 2023
function noop() { }
function run(fn) {
    return fn();
}
...
// (104:4) {#each footer_links as { label, link_list }}
function create_each_block(ctx) {
	...
	let nav;
	let t2;
	let each_value_1 = /*link_list*/ ctx[5];
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*footer_links*/ 2 && t0_value !== (t0_value = /*label*/ ctx[4] + "")) set_data(t0, t0_value);

			if (dirty & /*footer_links*/ 2) {
				each_value_1 = /*link_list*/ ctx[5];
				let i;
...
function instance($$self, $$props, $$invalidate) {
	...
	return [logo, footer_links, company_description, props];
}
