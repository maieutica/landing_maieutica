// Site Footer 1 - Updated August 10, 2023
function noop() { }
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-18bom7r");
...
function create_fragment$1(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			var a_nodes = children(a);
			t1 = claim_text(a_nodes, "Maieutica");
			a_nodes.forEach(detach);
			t2 = claim_text(span_nodes, " © 2023");
		...
		h() {
			attr(nav_1, "class", "svelte-18bom7r");
			attr(a, "href", "https://maieutica.mx");
			attr(a, "class", "svelte-18bom7r");
			attr(span, "class", "primo svelte-18bom7r");
			attr(div, "class", "social-links svelte-18bom7r");
			attr(footer, "class", "section-container svelte-18bom7r");
		},
		m(target, anchor) {
